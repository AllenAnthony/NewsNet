...
require('yargs')
  ...
  .option('foobaz')
  .completion()
  .getCompletion(['./test1.js', '--foo'], function (completions) {
    console.log(completions)
  })
```

Outputs the same completion choices as `./test1.js --foo`<kbd>TAB</kbd>: `--foobar` and `--foobaz`
...
```shell
./test1.js - follow ye instructions true
...
Ex. marks the spot:
  test1.js run foo  shiver me timbers, here's an example for ye
